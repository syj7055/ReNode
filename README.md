...
- 엄격 기준에서 매칭 결과가 비어도, 해당 리뷰의 최고 유사도 키워드 1개는 보존
...
```bash
.venv/Scripts/python.exe scripts/build_review_similarity_edges.py --threshold 0.72 --keyword-threshold 0.64 --keyword-fallback-threshold 0.6 --keyword-top-gap 0.04 --max-keywords-per-review 2 --batch-size 32
```
